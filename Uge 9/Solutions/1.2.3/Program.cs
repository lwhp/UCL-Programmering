...
namespace _1._2._3
{
    internal class Program
    {
        ...
        static double CalculateResult(string number1, string number2, string operatorString)
        {
            ...
            {
                case "+":
                    return Lommeregner.Add((int)intNumber1, (int)intNumber2);
                case "-":
                    return Lommeregner.Substract((int)intNumber1, (int)intNumber2);
                case "*":
                    return Lommeregner.Multiply((int)intNumber1, (int)intNumber2);
                case "/":
                    return Lommeregner.Divide((int)intNumber1, (int)intNumber2);
                default:
                    return 0;
            }
        }
        ...
        {
            double currentValue = CalculateResult(regnstykke[index - 1], regnstykke[index + 1], operatorString);
